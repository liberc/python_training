...
class TestAddContact(unittest.TestCase):
    ...
    def fill_contact_main(self, wd, contact):
    ...
    def fill_conact_dates(self, wd, contact_dates):
        # fill dates form
    ...
    def fill_conact_secondary(self, wd, contact_secondary):
        # fill secondary form
    ...
    def test_add_contact(self):
        ...
        self.fill_contact_main(wd, Contact(firstname="Ivan", middlename="Ivanovich", lastname="Ivanov", nickname="Ivashka", title="test_title", company="test_company_name", address="Moscow, Sovetskaja str, 100", homephone="-7{495}12345678", mobilephone="891612345678", workphone="891677788899", faxphone="891655544111", email1="testemail1@maill.ru", email2="testemail2@maill.ru", email3="testemail3@maill.ru", homepage="www.homepage.ru"))
        self.fill_conact_dates(wd, ContactDates(bday="1", bmonth="March", byear="1999", aday="8", amonth="July", ayear="2005"))
        self.fill_conact_secondary(wd, ContactSecondary(address="Moscow, Street Test", home="21", notes="this is test notes"))
